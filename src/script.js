window.onload = e => {
  class Table {
    constructor(matrixWrapper) {
      ...
      this.plusBottom = this.matrixWrapper.querySelector(
        '.bottom .squere-plus'
      );
    ...
    tableOver(e) {
      ...
      if (
        ...
        this.offsets.offsetLeft =
          target.getBoundingClientRect().top -
          this.matrix.getBoundingClientRect().top;
        this.offsets.offsetTop =
          target.getBoundingClientRect().left -
          this.matrix.getBoundingClientRect().left;
        ...
        const inCenterSquares = Array.prototype.filter.call(
          allSquares,
          function(allSquares) {
        ...
        if (inCenterSquares.includes(target)) {
          ...
          this.positions.row = Array.from(this.matrix.children).indexOf(
            currentRow
          );
          this.positions.div = Array.from(currentRow.children).indexOf(
            currentInnerDiv
          );
